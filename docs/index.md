...
1) You have git installed on your computer. Don't know how? Check out the [Installing Git](https://github.com/purdue-orbital/Git-for-Orbital/wiki/Installing-Git) page
...
For instructions on getting Git on your computer, check out the guide for [Installing Git](https://github.com/purdue-orbital/Git-for-Orbital/wiki/Installing-Git).
...
Want to know some more things concerning GitHub (the website you are on, and the thing that hosts all our repositories)? Check out [GitHub for Orbital](https://github.com/purdue-orbital/Git-for-Orbital/wiki/GitHub-for-Orbital).
* This is the guide to navigating around our GitHub page.

If you're wondering how to clone a repository from the organization page, check out the guide to [Cloning a Repository](https://github.com/purdue-orbital/Git-for-Orbital/wiki/GitHub-for-Orbital#getting-a-repository).
* This is if you want to grab a local copy of someone else's code within Orbital.

If you're ready to add an existing project to the organization's page, check out [Adding to the Organization](https://github.com/purdue-orbital/Git-for-Orbital/wiki/Adding-to-the-Organization).
